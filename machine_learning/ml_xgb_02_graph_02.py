# 수업 때 배운 방법으로 그래프 그리기 연습
# https://github.com/YoungriKIM/STUDY/blob/github/ml/m38_eval_graph3_cancer.py
...
modelscores = model.score(x_test, y_test)
print('score : ', modelscores)
